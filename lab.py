...
3. Download the December 2022 Yellow Taxi Trips Records from "https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page" and put the resulting PARQUET file into the folder named "data"
'''
